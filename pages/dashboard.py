...
# แก้ฟังก์ชันนี้ให้เป็นแบบนี้เจ้า
def play_alert_sound():
    # ให้เปลี่ยนสีพื้นหลังของหน้า Dashboard ทั้งหน้าให้เป็นสีแดงอ่อนๆ เมื่อมีเคสค้าง
    st.markdown("""
        <style>
            .stApp {
    ...
    st.warning("🚨 มีคนไข้เรียกพยาบาล! โปรดตรวจสอบรายการด้านล่าง")
